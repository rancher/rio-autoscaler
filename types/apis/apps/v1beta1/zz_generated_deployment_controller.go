...
type DeploymentHandlerFunc func(key string, obj *v1beta1.Deployment) (runtime.Object, error)

type DeploymentChangeHandlerFunc func(obj *v1beta1.Deployment) (runtime.Object, error)

type DeploymentLister interface {
	List(namespace string, selector labels.Selector) (ret []*v1beta1.Deployment, err error)
	Get(namespace, name string) (*v1beta1.Deployment, error)
}
...
type DeploymentInterface interface {
	...
	GetNamespaced(namespace, name string, opts metav1.GetOptions) (*v1beta1.Deployment, error)
	Get(name string, opts metav1.GetOptions) (*v1beta1.Deployment, error)
...
func (l *deploymentLister) List(namespace string, selector labels.Selector) (ret []*v1beta1.Deployment, err error) {
	err = cache.ListAllByNamespace(l.controller.Informer().GetIndexer(), namespace, selector, func(obj interface{}) {
		ret = append(ret, obj.(*v1beta1.Deployment))
	})
	return
}

func (l *deploymentLister) Get(namespace, name string) (*v1beta1.Deployment, error) {
	var key string
	if namespace != "" {
		key = namespace + "/" + name
	} else {
...
func (c *deploymentController) AddHandler(ctx context.Context, name string, handler DeploymentHandlerFunc) {
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		...
		} else if v, ok := obj.(*v1beta1.Deployment); ok {
...
func (c *deploymentController) AddClusterScopedHandler(ctx context.Context, name, cluster string, handler DeploymentHandlerFunc) {
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		if obj == nil {
			return handler(key, nil)
		} else if v, ok := obj.(*v1beta1.Deployment); ok && controller.ObjectInCluster(cluster, obj) {
			return handler(key, v)
		} else {
			return nil, nil
		}
...
func (s *deploymentClient) Create(o *v1beta1.Deployment) (*v1beta1.Deployment, error) {
	obj, err := s.objectClient.Create(o)
	return obj.(*v1beta1.Deployment), err
}

func (s *deploymentClient) Get(name string, opts metav1.GetOptions) (*v1beta1.Deployment, error) {
	obj, err := s.objectClient.Get(name, opts)
	return obj.(*v1beta1.Deployment), err
}

func (s *deploymentClient) GetNamespaced(namespace, name string, opts metav1.GetOptions) (*v1beta1.Deployment, error) {
	obj, err := s.objectClient.GetNamespaced(namespace, name, opts)
	return obj.(*v1beta1.Deployment), err
}

func (s *deploymentClient) Update(o *v1beta1.Deployment) (*v1beta1.Deployment, error) {
...
type DeploymentIndexer func(obj *v1beta1.Deployment) ([]string, error)

type DeploymentClientCache interface {
	Get(namespace, name string) (*v1beta1.Deployment, error)
	List(namespace string, selector labels.Selector) ([]*v1beta1.Deployment, error)

	Index(name string, indexer DeploymentIndexer)
	GetIndexed(name, key string) ([]*v1beta1.Deployment, error)
}

type DeploymentClient interface {
	Create(*v1beta1.Deployment) (*v1beta1.Deployment, error)
	Get(namespace, name string, opts metav1.GetOptions) (*v1beta1.Deployment, error)
	Update(*v1beta1.Deployment) (*v1beta1.Deployment, error)
...
func (n *deploymentClient2) Create(obj *v1beta1.Deployment) (*v1beta1.Deployment, error) {
	return n.iface.Create(obj)
}

func (n *deploymentClient2) Get(namespace, name string, opts metav1.GetOptions) (*v1beta1.Deployment, error) {
	return n.iface.GetNamespaced(namespace, name, opts)
}

func (n *deploymentClient2) Update(obj *v1beta1.Deployment) (*v1beta1.Deployment, error) {
...
func (n *deploymentClientCache) Get(namespace, name string) (*v1beta1.Deployment, error) {
	return n.client.controller.Lister().Get(namespace, name)
}

func (n *deploymentClientCache) List(namespace string, selector labels.Selector) ([]*v1beta1.Deployment, error) {
...
func (n *deploymentClientCache) Index(name string, indexer DeploymentIndexer) {
	err := n.client.controller.Informer().GetIndexer().AddIndexers(map[string]cache.IndexFunc{
		name: func(obj interface{}) ([]string, error) {
			if v, ok := obj.(*v1beta1.Deployment); ok {
				return indexer(v)
			}
			return nil, nil
		},
...
func (n *deploymentClientCache) GetIndexed(name, key string) ([]*v1beta1.Deployment, error) {
...
func (n *deploymentLifecycleDelegate) Create(obj *v1beta1.Deployment) (runtime.Object, error) {
	if n.create == nil {
		return obj, nil
	}
	return n.create(obj)
...
func (n *deploymentLifecycleDelegate) Remove(obj *v1beta1.Deployment) (runtime.Object, error) {
	if n.remove == nil {
		return obj, nil
	}
	return n.remove(obj)
...
func (n *deploymentLifecycleDelegate) Updated(obj *v1beta1.Deployment) (runtime.Object, error) {
	if n.update == nil {
		return obj, nil
	}
	return n.update(obj)
