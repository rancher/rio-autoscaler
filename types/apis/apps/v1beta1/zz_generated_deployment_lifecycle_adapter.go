...
type DeploymentLifecycle interface {
	Create(obj *v1beta1.Deployment) (runtime.Object, error)
	Remove(obj *v1beta1.Deployment) (runtime.Object, error)
	Updated(obj *v1beta1.Deployment) (runtime.Object, error)
}
...
func (w *deploymentLifecycleAdapter) Create(obj runtime.Object) (runtime.Object, error) {
	o, err := w.lifecycle.Create(obj.(*v1beta1.Deployment))
	if o == nil {
		return nil, err
	}
	return o, err
...
func (w *deploymentLifecycleAdapter) Finalize(obj runtime.Object) (runtime.Object, error) {
	o, err := w.lifecycle.Remove(obj.(*v1beta1.Deployment))
	if o == nil {
		return nil, err
	}
	return o, err
...
func (w *deploymentLifecycleAdapter) Updated(obj runtime.Object) (runtime.Object, error) {
	o, err := w.lifecycle.Updated(obj.(*v1beta1.Deployment))
	if o == nil {
		return nil, err
	}
	return o, err
...
func NewDeploymentLifecycleAdapter(name string, clusterScoped bool, client DeploymentInterface, l DeploymentLifecycle) DeploymentHandlerFunc {
	...
	return func(key string, obj *v1beta1.Deployment) (runtime.Object, error) {
